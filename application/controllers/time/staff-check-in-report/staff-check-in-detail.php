...
if($this->getRequest()->isXmlHttpRequest()) {
    ...
    $this->_helper->viewRenderer->setRender('staff-check-in-report/partials/check-in-detail-list');
} else
    $this->_helper->viewRenderer->setRender('staff-check-in-report/check-in-detail');