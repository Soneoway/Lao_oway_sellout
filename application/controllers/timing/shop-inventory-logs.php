...
$logs_shop = $QShopInventoryLogs->fetchPagination($page, $limit, $total, $params);
$this->view->logs_shop = $logs_shop;
...
$this->view->url             = HOST.'timing/shop-inventory-logs'.( $params ? '?'.http_build_query($params).'&' : '?' );
$this->view->desc            = $desc;
