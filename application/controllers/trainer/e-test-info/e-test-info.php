...
$itemModel                  = new Application_Model_QuestionsHeader();
...
$this->view->desc    = $desc;
$this->view->sort    = $sort;
$this->view->url    = HOST.'trainer/e-test-info/'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
$this->_helper->viewRenderer->setRender('e-test-info/index');