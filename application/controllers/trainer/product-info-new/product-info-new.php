...
$itemModel                  = new Application_Model_ProductInfoTopic();
...
$this->view->desc    = $desc;
$this->view->sort    = $sort;
$this->view->url    = HOST.'trainer/product-info-new/'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
$this->_helper->viewRenderer->setRender('product-info-new/index');