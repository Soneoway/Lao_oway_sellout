...
$itemModel                  = new Application_Model_CheckListTopic();
...
$this->view->desc    = $desc;
$this->view->sort    = $sort;
$this->view->url    = HOST.'trainer/manage-shop-check/'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
$this->_helper->viewRenderer->setRender('manage-shop-check/index');