...
$itemModel                  = new Application_Model_SalesKnowledgeBase();
...
$this->view->desc    = $desc;
$this->view->sort    = $sort;
$this->view->url    = HOST.'trainer/knowledge-base/'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
$this->_helper->viewRenderer->setRender('knowledge-base/index');