...
$location_checked         = $this->getRequest()->getParam('location_checked', 0);
$location_not_check         = $this->getRequest()->getParam('location_not_check', 0);
...
$params = array_filter(array(
    ...
    'location_not_check'        => $location_not_check
...
$this->view->url         = HOST.'report/store-visit'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
$this->_helper->viewRenderer->setRender('/store-visit/index');
?>