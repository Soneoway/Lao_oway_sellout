...
if (!empty($_GET)) { 
    $bs_area = $QBsArea->bs_area_list($params);
}

$this->view->params = $params;
$this->view->bs_area = $bs_area;
...
if($this->getRequest()->isXmlHttpRequest()) {
    ...
    $this->_helper->viewRenderer->setRender('bs-area-control/partials/list');
} else
    $this->_helper->viewRenderer->setRender('bs-area-control/index');