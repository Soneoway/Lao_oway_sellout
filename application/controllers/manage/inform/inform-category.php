...
$this->view->url      = HOST.'manage/inform-category'.( $params ? '?'.http_build_query($params).'&' : '?' );
$this->view->offset   = $limit*($page-1);

$this->view->category_cache = $QCategory->get_cache();
...
$this->_helper->viewRenderer->setRender('inform/category');