...
$where = array();
$where[] = $QMBP->getAdapter()->quoteInto('area_name = ?', $area_name);
$where[] = $QMBP->getAdapter()->quoteInto('month_year = ?', $month_year);

$mhbpd_list = $QMBP->fetchAll($where)->ToArray();

$this->view->monthly_birthday_pc_detail = $mhbpd_list;
$this->view->area_id = $area_id;
$this->view->params = $params;

//back url
$this->view->back_url = $this->getRequest()->getServer('HTTP_REFERER');
$this->_helper->viewRenderer->setRender('/monthly-birthday-pc/create');