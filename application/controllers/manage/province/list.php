...
$this->view->url    = HOST.'manage/province/'.( $params ? '?'.http_build_query($params).'&' : '?' );
...
if($this->getRequest()->isXmlHttpRequest()) {
    ...
    $this->_helper->viewRenderer->setRender('province/partials/searchname');
} else {
    $this->_helper->viewRenderer->setRender('province/index');
}